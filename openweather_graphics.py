...
class OpenWeather_Graphics(displayio.Group):
    def __init__(self, root_group, *, am_pm=True):
        ...
        # self.internal_temp_text = Label(self.small_font, max_glyphs=6)
        # self.internal_temp_text.x = 200
        # self.internal_temp_text.y = 225
        # self.internal_temp_text.color = 0xFFFFFF
        # self._text_group.append(self.internal_temp_text)
